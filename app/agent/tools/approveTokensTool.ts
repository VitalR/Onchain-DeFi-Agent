...
export const ApproveTokensTool: AgentTool = {
  ...
  description: "Approves the Aerodrome Router to pull unlimited EURC and USDC from the wallet.",
  type: "function",
  function: {
    name: "approve_tokens_for_router",
    description: "Sets unlimited approvals for EURC and USDC tokens for the Aerodrome Router.",
    parameters: {
      type: "object",
      properties: {},
      required: [],
